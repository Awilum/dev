...
### [Accent Color](https://docs.master.co/css/accent-color) 
| class | properties |
|---|---|
...
### [Caret Color](https://docs.master.co/css/caret-color) 
| class | properties |
|---|---|
...
### [Cursor](https://docs.master.co/css/cursor) 
| class | properties |
|---|---|
...
### [Box Decoration Break](https://docs.master.co/css/box-decoration-break) 
| class | properties |
|---|---|
...
### [Break After](https://docs.master.co/css/break-after) 
| class | properties |
|---|---|
...
### [Break Before](https://docs.master.co/css/break-before) 
| class | properties |
|---|---|
...
### [Break Inside](https://docs.master.co/css/break-inside) 
| class | properties |
|---|---|
...
### [Clear](https://docs.master.co/css/clear) 
| class | properties |
|---|---|
...
### [Columns](https://docs.master.co/css/columns) 
| class | properties |
|---|---|
| columns:value / cols:value | columns: value |
| cols:count\|width | columns: count width |

### [Column Span](https://docs.master.co/css/column-span) 
| class | properties |
|---|---|
...
### [Direction](https://docs.master.co/css/direction) 
| class | properties |
|---|---|
| direction:ltr | direction: ltr |
| direction:rtl | direction: rtl |

### [Display](https://docs.master.co/css/display) 
| class | properties |
|---|---|
...
### [Float](https://docs.master.co/css/float) 
| class | properties |
|---|---|
...
### [Inset](https://docs.master.co/css/inset) 
| class | properties |
|---|---|
...
### [Isolation](https://docs.master.co/css/isolation) 
| class | properties |
|---|---|
...
### [Overflow](https://docs.master.co/css/overflow) 
| class | properties |
|---|---|
...
### [Position](https://docs.master.co/css/position) 
| class | properties |
|---|---|
...
### [Z Index](https://docs.master.co/css/z-index) 
| class | properties |
|---|---|
| z-index:value / z:value | z-index: value |

### [Flex](https://docs.master.co/css/flex) 
| class | properties |
|---|---|
...
### [Flex Basis](https://docs.master.co/css/flex-basis) 
| class | properties |
|---|---|
...
### [Flex Direction](https://docs.master.co/css/flex-direction) 
| class | properties |
|---|---|
...
### [Flex Grow](https://docs.master.co/css/flex-grow) 
| class | properties |
|---|---|
| flex-grow:value | flex-grow: value |

### [Flex Shrink](https://docs.master.co/css/flex-shrink) 
| class | properties |
|---|---|
| flex-shrink:value | flex-shrink: value |

### [Flex Wrap](https://docs.master.co/css/flex-wrap) 
| class | properties |
|---|---|
...
### [Grid](https://docs.master.co/css/grid) 
| class | properties |
|---|---|
...
### [Grid Auto Columns](https://docs.master.co/css/grid-auto-columns) 
| class | properties |
|---|---|
...
### [Grid Auto Flow](https://docs.master.co/css/grid-auto-flow) 
| class | properties |
|---|---|
...
### [Grid Auto Rows](https://docs.master.co/css/grid-auto-rows) 
| class | properties |
|---|---|
...
### [Grid Column](https://docs.master.co/css/grid-column) 
| class | properties |
|---|---|
...
### [Grid Rows](https://docs.master.co/css/grid-rows) 
| class | properties |
|---|---|
| grid-rows:value | display: grid;grid-auto-flow: column;grid-template-rows: repeat(value, minmax(0, 1fr)) |

### [Grid Template](https://docs.master.co/css/grid-template) 
| class | properties |
|---|---|
...
### [Grid Template Areas](https://docs.master.co/css/grid-template-areas) 
| class | properties |
|---|---|
| grid-template-areas:value | grid-template-areas: value |
| grid-template-areas:none | grid-template-areas: none |

### [Grid Template Columns](https://docs.master.co/css/grid-template-columns) 
| class | properties |
|---|---|
...
### [Grid Template Rows](https://docs.master.co/css/grid-template-rows) 
| class | properties |
|---|---|
...
### [Align Content](https://docs.master.co/css/align-content) 
| class | properties |
|---|---|
...
### [Align Items](https://docs.master.co/css/align-items) 
| class | properties |
|---|---|
...
### [Align Self](https://docs.master.co/css/align-self) 
| class | properties |
|---|---|
...
### [Gap](https://docs.master.co/css/gap) 
| class | properties |
|---|---|
| gap:size | gap: size |
...
### [Justify Content](https://docs.master.co/css/justify-content) 
| class | properties |
|---|---|
...
### [Justify Items](https://docs.master.co/css/justify-items) 
| class | properties |
|---|---|
...
### [Justify Self](https://docs.master.co/css/justify-self) 
| class | properties |
|---|---|
...
### [Order](https://docs.master.co/css/order) 
| class | properties |
|---|---|
...
### [Place Content](https://docs.master.co/css/place-content) 
| class | properties |
|---|---|
...
### [Place Items](https://docs.master.co/css/place-items) 
| class | properties |
|---|---|
...
### [Place Self](https://docs.master.co/css/place-self) 
| class | properties |
|---|---|
...
### [Border Collapse](https://docs.master.co/css/border-collapse) 
| class | properties |
|---|---|
...
### [Table Layout](https://docs.master.co/css/table-layout) 
| class | properties |
|---|---|
...
### [Object Fit](https://docs.master.co/css/object-fit) 
| class | properties |
|---|---|
...
### [Object Position](https://docs.master.co/css/object-position) 
| class | properties |
|---|---|
...
### [Font](https://docs.master.co/css/font) 
| class | properties |
|---|---|
...
### [Font Color](https://docs.master.co/css/font-color) 
| class | properties |
|---|---|
...
### [Font Family](https://docs.master.co/css/font-family) 
| class | properties |
|---|---|
...
### [Font Size](https://docs.master.co/css/font-size) 
| class | properties |
|---|---|
| font-size:size / font:size / f:size | font-size: size |

### [Font Style](https://docs.master.co/css/font-style) 
| class | properties |
|---|---|
...
### [Font Variant Numeric](https://docs.master.co/css/font-variant-numeric) 
| class | properties |
|---|---|
...
### [Font Weight](https://docs.master.co/css/font-weight) 
| class | properties |
|---|---|
...
### [Font Smoothing](https://docs.master.co/css/font-smoothing) 
| class | properties |
|---|---|
...
### [Text Align](https://docs.master.co/css/text-align) 
| class | properties |
|---|---|
...
### [Text Decoration](https://docs.master.co/css/text-decoration) 
| class | properties |
|---|---|
...
### [Text Decoration Color](https://docs.master.co/css/text-decoration-color) 
| class | properties |
|---|---|
...
### [Text Decoration Line](https://docs.master.co/css/text-decoration-line) 
| class | properties |
|---|---|
...
### [Text Decoration Style](https://docs.master.co/css/text-decoration-style) 
| class | properties |
|---|---|
...
### [Text Decoration Thickness](https://docs.master.co/css/text-decoration-thickness) 
| class | properties |
|---|---|
| text-decoration-thickness:size / text-decoration:size | text-decoration-thickness: size |

### [Text Fill Color](https://docs.master.co/css/text-fill-color) 
| class | properties |
|---|---|
...
### [Text Indent](https://docs.master.co/css/text-indent) 
| class | properties |
|---|---|
| text-indent:offset | text-indent: offset |

### [Text Orientation](https://docs.master.co/css/text-orientation) 
| class | properties |
|---|---|
...
### [Text Overflow](https://docs.master.co/css/text-overflow) 
| class | properties |
|---|---|
...
### [Text Shadow](https://docs.master.co/css/text-shadow) 
| class | properties |
|---|---|
...
### [Text Size](https://docs.master.co/css/text-size) 
| class | properties |
|---|---|
| text:size / t:size |  |

### [Text Stroke](https://docs.master.co/css/text-stroke) 
| class | properties |
|---|---|
| text-stroke:length\|color | -webkit-text-stroke: length color |

### [Text Stroke Color](https://docs.master.co/css/text-stroke-color) 
| class | properties |
|---|---|
...
### [Text Stroke Width](https://docs.master.co/css/text-stroke-width) 
| class | properties |
|---|---|
| text-stroke-width:value / text-stroke:value | -webkit-text-stroke-width: value |

### [Text Transform](https://docs.master.co/css/text-transform) 
| class | properties |
|---|---|
...
### [Text Underline Offset](https://docs.master.co/css/text-underline-offset) 
| class | properties |
|---|---|
| text-underline-offset:offset | text-underline-offset: offset |

### [Text Rendering](https://docs.master.co/css/text-rendering) 
| class | properties |
|---|---|
...
### [List Style](https://docs.master.co/css/list-style) 
| class | properties |
|---|---|
| list-style:type\|position\|image | list-style: type position image |

### [List Style Image](https://docs.master.co/css/list-style-image) 
| class | properties |
|---|---|
...
### [List Style Position](https://docs.master.co/css/list-style-position) 
| class | properties |
|---|---|
...
### [List Style Type](https://docs.master.co/css/list-style-type) 
| class | properties |
|---|---|
...
### [Letter Spacing](https://docs.master.co/css/letter-spacing) 
| class | properties |
|---|---|
| letter-spacing:value / ls:value | letter-spacing: value |

### [Line Clamp](https://docs.master.co/css/line-clamp) 
| class | properties |
|---|---|
...
### [Line Height](https://docs.master.co/css/line-height) 
| class | properties |
|---|---|
| line-height:size / lh:size | line-height: size |

### [Content](https://docs.master.co/css/content) 
| class | properties |
|---|---|
...
### [Vertical Align](https://docs.master.co/css/vertical-align) 
| class | properties |
|---|---|
...
### [White Space](https://docs.master.co/css/white-space) 
| class | properties |
|---|---|
...
### [Word Break](https://docs.master.co/css/word-break) 
| class | properties |
|---|---|
...
### [Word Spacing](https://docs.master.co/css/word-spacing) 
| class | properties |
|---|---|
| word-spacing:value | word-spacing: value |

### [Writing Mode](https://docs.master.co/css/writing-mode) 
| class | properties |
|---|---|
...
### [Background](https://docs.master.co/css/background) 
| class | properties |
|---|---|
| background:param / bg:param | background: param |
| background:param,… / bg:param,… | background: param, … |

### [Backdrop Filter](https://docs.master.co/css/backdrop-filter) 
| class | properties |
|---|---|
...
### [Background Attachment](https://docs.master.co/css/background-attachment) 
| class | properties |
|---|---|
...
### [Background Blend Mode](https://docs.master.co/css/background-blend-mode) 
| class | properties |
|---|---|
...
### [Background Clip](https://docs.master.co/css/background-clip) 
| class | properties |
|---|---|
...
### [Background Color](https://docs.master.co/css/background-color) 
| class | properties |
|---|---|
...
### [Background Image](https://docs.master.co/css/background-image) 
| class | properties |
|---|---|
...
### [Background Origin](https://docs.master.co/css/background-origin) 
| class | properties |
|---|---|
...
### [Background Position](https://docs.master.co/css/background-position) 
| class | properties |
|---|---|
...
### [Background Repeat](https://docs.master.co/css/background-repeat) 
| class | properties |
|---|---|
...
### [Background Size](https://docs.master.co/css/background-size) 
| class | properties |
|---|---|
...
### [Border](https://docs.master.co/css/border) 
| class | properties |
|---|---|
...
### [Border Color](https://docs.master.co/css/border-color) 
| class | properties |
|---|---|
...
### [Border Style](https://docs.master.co/css/border-style) 
| class | properties |
|---|---|
...
### [Border Width](https://docs.master.co/css/border-width) 
| class | properties |
|---|---|
...
### [Border Radius](https://docs.master.co/css/border-radius) 
| class | properties |
|---|---|
...
### [Outline](https://docs.master.co/css/outline) 
| class | properties |
|---|---|
...
### [Outline Color](https://docs.master.co/css/outline-color) 
| class | properties |
|---|---|
...
### [Outline Offset](https://docs.master.co/css/outline-offset) 
| class | properties |
|---|---|
| outline-offset:offset | outline-offset: offset |

### [Outline Style](https://docs.master.co/css/outline-style) 
| class | properties |
|---|---|
...
### [Outline Width](https://docs.master.co/css/outline-width) 
| class | properties |
|---|---|
...
### [Shape Image Threshold](https://docs.master.co/css/shape-image-threshold) 
| class | properties |
|---|---|
| shape-image-threshold:value | shape-image-threshold: value |

### [Shape Margin](https://docs.master.co/css/shape-margin) 
| class | properties |
|---|---|
| shape-margin:size / shape:size | shape-margin: size |

### [Shape Outside](https://docs.master.co/css/shape-outside) 
| class | properties |
|---|---|
...
### [Clip Path](https://docs.master.co/css/clip-path) 
| class | properties |
|---|---|
...
### [Aspect Ratio](https://docs.master.co/css/aspect-ratio) 
| class | properties |
|---|---|
...
### [Box Sizing](https://docs.master.co/css/box-sizing) 
| class | properties |
|---|---|
...
### [Width](https://docs.master.co/css/width) 
| class | properties |
|---|---|
...
### [Min Width](https://docs.master.co/css/min-width) 
| class | properties |
|---|---|
...
### [Max Width](https://docs.master.co/css/max-width) 
| class | properties |
|---|---|
...
### [Height](https://docs.master.co/css/height) 
| class | properties |
|---|---|
...
### [Min Height](https://docs.master.co/css/min-height) 
| class | properties |
|---|---|
...
### [Max Height](https://docs.master.co/css/max-height) 
| class | properties |
|---|---|
...
### [Margin](https://docs.master.co/css/margin) 
| class | properties |
|---|---|
...
### [Padding](https://docs.master.co/css/padding) 
| class | properties |
|---|---|
...
### [Transition](https://docs.master.co/css/transition) 
| class | properties |
|---|---|
...
### [Transform](https://docs.master.co/css/transform) 
| class | properties |
|---|---|
...
### [Transform Box](https://docs.master.co/css/transform-box) 
| class | properties |
|---|---|
...
### [Transform Origin](https://docs.master.co/css/transform-origin) 
| class | properties |
|---|---|
...
### [Transform Style](https://docs.master.co/css/transform-style) 
| class | properties |
|---|---|
...
### [Animation Duration](https://docs.master.co/css/animation-duration) 
| class | properties |
|---|---|
| animation-duration:milliSeconds,… / @duration:milliSeconds,… | animation-duration: milliSeconds, … |

### [Animation Fill Mode](https://docs.master.co/css/animation-fill-mode) 
| class | properties |
|---|---|
...
### [Animation Iteration Count](https://docs.master.co/css/animation-iteration-count) 
| class | properties |
|---|---|
...
### [Animation Name](https://docs.master.co/css/animation-name) 
| class | properties |
|---|---|
| animation-name:name,… / @name:name,… | animation-name: name, … |

### [Animation Play State](https://docs.master.co/css/animation-play-state) 
| class | properties |
|---|---|
...
### [Animation Timing Function](https://docs.master.co/css/animation-timing-function) 
| class | properties |
|---|---|
...
### [Fill](https://docs.master.co/css/fill) 
| class | properties |
|---|---|
...
### [Stroke](https://docs.master.co/css/stroke) 
| class | properties |
|---|---|
...
### [Stroke Width](https://docs.master.co/css/stroke-width) 
| class | properties |
|---|---|
| stroke-width:size / stroke:size | stroke-width: size |

### [Visibility](https://docs.master.co/css/visibility) 
| class | properties |
|---|---|
...
### [Opacity](https://docs.master.co/css/opacity) 
| class | properties |
|---|---|
...
### [Box Shadow](https://docs.master.co/css/box-shadow) 
| class | properties |
|---|---|
...
### [Filter](https://docs.master.co/css/filter) 
| class | properties |
|---|---|
...
### [Mask Image](https://docs.master.co/css/mask-image) 
| class | properties |
|---|---|
| mask-image:image,… | mask-image: image, …;-webkit-mask-image: image, … |

### [Mix Blend Mode](https://docs.master.co/css/mix-blend-mode) 
| class | properties |
|---|---|
...
### [Overscroll Behavior](https://docs.master.co/css/overscroll-behavior) 
| class | properties |
|---|---|
...
### [Scroll Behavior](https://docs.master.co/css/scroll-behavior) 
| class | properties |
|---|---|
...
### [Scroll Margin](https://docs.master.co/css/scroll-margin) 
| class | properties |
|---|---|
...
### [Scroll Padding](https://docs.master.co/css/scroll-padding) 
| class | properties |
|---|---|
...
### [Scroll Snap Align](https://docs.master.co/css/scroll-snap-align) 
| class | properties |
|---|---|
...
### [Scroll Snap Stop](https://docs.master.co/css/scroll-snap-stop) 
| class | properties |
|---|---|
...
### [Scroll Snap Type](https://docs.master.co/css/scroll-snap-type) 
| class | properties |
|---|---|
...
### [Pointer Events](https://docs.master.co/css/pointer-events) 
| class | properties |
|---|---|
...
### [Resize](https://docs.master.co/css/resize) 
| class | properties |
|---|---|
...
### [Touch Action](https://docs.master.co/css/touch-action) 
| class | properties |
|---|---|
...
### [User Drag](https://docs.master.co/css/user-drag) 
| class | properties |
|---|---|
...
### [User Select](https://docs.master.co/css/user-select) 
| class | properties |
|---|---|
...
### [Screen Readers](https://docs.master.co/css/screen-readers) 
| class | properties |
|---|---|
...
### [Contain](https://docs.master.co/css/contain) 
| class | properties |
|---|---|
...
### [Will Change](https://docs.master.co/css/will-change) 
| class | properties |
|---|---|
| will-change:value | will-change: value |

### [Variable](https://docs.master.co/css/variable) 
| class | properties |
|---|---|
| $key:value | --key: value |
