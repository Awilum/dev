...
seo:
  title: JSON for Modern Open Source Flat Files Flextype CMS
  description: Read the documentation about using JSON in Modern Open Source Flat Files Flextype CMS
breadcrumbs:
  -
    title: "Core Concepts"
