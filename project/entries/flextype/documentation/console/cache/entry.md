...
```text
php ./bin/flextype cache:clear -h
...
```text
php ./bin/flextype cache:clear-config -h
...
```text
php ./bin/flextype cache:clear-data -h
...
```text
php ./bin/flextype cache:clear-routes -h
...
```text
php ./bin/flextype cache:delete -h
...
```text
php ./bin/flextype cache:delete-multiple -h
...
```text
php ./bin/flextype cache:get-multiple -h
...
```text
php ./bin/flextype cache:get-has -h
...
```text
php ./bin/flextype cache:set-multiple -h
