...
For more details <a href="[url]/flextype/09/documentation/core/parsers/markdown">read the guide for the MARKDOWN</a>.
...
For more details <a href="[url]/flextype/09/documentation/core/parsers/shortcode">read the guide for the SHORTCODE</a>.
