...
breadcrumbs:
  -
    title: "Rest API"
    link: "[url]/flextype/09/flextype/09/documentation/rest-api/"
on_this_page:
  -
    title: "Endpoints"
    link: "endpoints"
...
`options` is an array of valid values for [filter()](s://github.com/flextype/09/flextype/blob/dev/src/flextype/09/Support/Helpers/FilterHelper.php) and [find()](s://github.com/flextype/09/flextype/blob/dev/src/flextype/09/Support/Helpers/FindHelper.php) helpers.
