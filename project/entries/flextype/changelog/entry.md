---
title: 'Changelog'
template: flextype/changelog
visibility: visible
created_at: '22-09-2019 19:15'
published_at: '22-09-2019 19:15'
description: 'Stay up to date with the latest Flextype changes'
uuid: 94f5eff7-28fb-4fce-a4d0-7dffcda31f4a
published_by: bb7b1232-077e-4e14-8182-df386ed9aa1a
created_by: bb7b1232-077e-4e14-8182-df386ed9aa1a
seo:
  title: Get the latest changes in Open Source Hybrid Content Management System
  description: Stay up to date with the latest changes in Open Source Hybrid Content Management System
  keywords: Flextype Changelog, Flextype CMS Changelog, Headless CMS Changelog, Flat File CMS Changelog, Flat File Content Management System Changelog, PHP CMS Changelog, Changelog, Content, Management, System, PHP, CMS
---
...
* **core** New Media API for work with media uploads.
    ...
    See: http://docs.flextype.org/core/media
...
* **entries** New simplified logic for entries methods: `fetch()` `fetchSingle()` and `fetchCollection()`
    ...
    * `public function fetchCollection(string $path, $filter = []) : array`
    ...
    See: http://docs.flextype.org/core/entries#methods
...
* **collections** New Collection functionality on top of Doctrine Collections.
    ...
    See: http://docs.flextype.org/core/collections
...
* **core:** all images links should be updated
    ```
    http://docs.flextype.org/content/media
    ```
...
* **core:** add alternative comparison syntax for Entries API  
    ...
    ```  
    docs: http://docs.flextype.org/themes/entries-fetch
